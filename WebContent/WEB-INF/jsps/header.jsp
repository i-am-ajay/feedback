...
<div class="bg-light">
	...
	<div class="row bg-light">
		...
		<div class="col-4"><blockquote class="blockquote text-center">SIR GANGA RAM HOSPITAL NEW DELHI
				<blockquote class="blockquote small">Employee Feedback</blockquote>
			</blockquote></div>
